...
5. پس از اتمام اسکن، می‌توانید کلیدها را با دکمه `Verify Selected` تایید کنید (این عملیات با ارسال درخواست واقعی به API هر سرویس، زنده بودن کلیدها را بررسی کرده و کلیدهای فعال را با رنگ قرمز مشخص می‌کند).
